...
The compiler-only baseline must cover:

* ordinary pointer loads and stores;
* structure fields;
* arrays and indexing;
* aliases and pointer arithmetic;
* pointer casts;
* PHI joins;
* cross-function calls;
* pointers stored in ordinary application-owned structures.

The baseline should not require ``swmmu_ptr``, ``swmmu_dynamic_ptr``, or
mallocng-specific annotations for these cases.
