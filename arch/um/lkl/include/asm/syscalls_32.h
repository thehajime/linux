...
asmlinkage long sys32_sync_file_range(int, unsigned, unsigned, unsigned,
				      unsigned, unsigned int);
asmlinkage long sys32_sync_file_range2(int, unsigned int, unsigned, unsigned,
				       unsigned, unsigned);
asmlinkage long sys32_fadvise64(int, unsigned, unsigned, size_t, int);
asmlinkage long sys32_fallocate(int, int, unsigned, unsigned, unsigned,
				unsigned);
